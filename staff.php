...
<table class="table table-bordered table-striped" cellpadding="10" cellspacing="0">
	...
	<tr>
		...
		<td><?= $row["tglreg"]; ?></td>
		<td>
			<a href="?view=editstaff&id=<?= $row["id"]; ?>" onclick="return confirm('yakin ingin merubah data Staff?');"><input type="submit" name="simpan" value="EDIT" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm mb-2 btn-left"></a>
		</td>
		<td>
